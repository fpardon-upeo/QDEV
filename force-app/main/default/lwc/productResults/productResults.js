...
import getSearchResultsPriceDate from '@salesforce/apex/ProductSearchControllerPriceDate.search';
...
import getBrandsDrop from '@salesforce/apex/BrandController.getBrands';
...
import B2BSearch_Standard from '@salesforce/label/c.B2BSearch_Standard';
import B2BSearch_Price from '@salesforce/label/c.B2BSearch_Price';
import B2BSearch_Delivery from '@salesforce/label/c.B2BSearch_Delivery';
import B2BSearch_Toast_Favorites from '@salesforce/label/c.B2BSearch_Toast_Favorites';
import B2BSearch_Toast_No_Filters from '@salesforce/label/c.B2BSearch_Toast_No_Filters';
import B2BSearcht_Toast_Add_CartItem from '@salesforce/label/c.B2BSearcht_Toast_Add_CartItem';
...
export default class ProductResults extends LightningElement {
    ...
    standardLabel = B2BSearch_Standard;
    priceLabel = B2BSearch_Price;
    deliveryLabel = B2BSearch_Delivery;
    B2BSearch_Toast_Favorites = B2BSearch_Toast_Favorites;
    B2BSearch_Toast_No_Filters = B2BSearch_Toast_No_Filters;
    B2BSearcht_Toast_Add_CartItem = B2BSearcht_Toast_Add_CartItem;
    @api recordType;
    ...
    @track showBestPrice = false;
    @track showFastestDel = false;
    @track resetPaginationComponent = false;
    ...
    handleSortChange(event) {
        this.sortingOption = event.detail.value;
        console.log('sortingOption', this.sortingOption);
    }
...
//----------------------------------------------CONTROLLER----------------------------------------------------------//
    ...
    handleSearch() {
        console.log('brandFilter', this.selectedBrands);
        console.log('sortingOption', this.sortingOption);
        if(this.sortingOption != null && this.sortingOption !== undefined && this.sortingOption !== '') {
            console.log('running searchFiltered');
            console.log('sortingOption', this.sortingOption);
            if(this.sortingOption === 'Price Ascending') {
                this.searchFiltered();
            } else {
                this.searchFilteredDate();
            }
        }
        else {
            this.search();
    ...
    searchFiltered() {
        ...
        if (
            ...
            this.message = this.B2BSearch_Toast_No_Filters;
            ...
            getSearchResultsPriceDate({
                ...
                .then((data) => {
                    ...
                    if(data != '[]'){
                        ...
                        console.log('totalRecords in filtered search: ', this.totalRecords);
                    }else{
            ...
            getSearchResultsPriceDate({
                ...
                .then((data) => {
                    ...
                    if(data != '[]'){
                        ...
                        this.noResults = true;
                        this.totalRecords = this.searchResults[0].totalRecords;
                        console.log('totalRecords in date search: ', this.totalRecords);
                    }else{
                        this.showNoDataMessage = true;
                        this.noResults = false;
                    }
     ...
     */
        ...
        if (
            ...
            this.noResults = true;
            this.isLoaded = !this.isLoaded;
            console.log('exclude products : ', this.excludedProducts);
            getSearchResults({
                recordType : this.recordType,
                Dim1: this.widthValue,
                Serie: this.heightValue,
                ...
                .then((data) => {
                    ...
                    if(data != '[]'){
                        ...
                        //console.log('searchResults id : ', this.searchResults[0].id);
                        //console.log('searchResults : ', this.searchResults[0].totalRecords);
                        //.log('searchResults size = ' + this.searchResults.length);
                        this.searchResultsSize = this.searchResults.length;
                        this.showNoDataMessage = false;
                        this.noResults = true;
                        this.totalRecords = this.searchResults[0].totalRecords;
                        console.log('totalRecords in ranked search: ', this.totalRecords);
                    }else{
                        this.showNoDataMessage = true;
                        this.noResults = false;
                    }
    ...
    saveFavorite(event){
        ...
        console.log('favorite brands : ', this.selectedBrands);
        console.log('favorite brands : ', JSON.stringify(this.selectedBrands));
        setFavoriteBrands({brand: JSON.stringify(this.selectedBrands), userId: this.userId})
            .then((data) => {
                //console.log('data : ',data);
                this._title = 'Success';
                this.message = this.B2BSearch_Toast_Favorites;
    ...
    handleStandardBtnClick(event){
        this.resetPage = true;
        this.offset = 0;
        console.log('@@@@@@@@@ handleStandardBtnClick and resetPage = ' + this.resetPage);
        this.showStandard = !this.showStandard;
        this.showBestPrice = !this.showStandard;
        this.showFastestDel = !this.showStandard;
        this.sortingOption = null;
        this.handleSearch();
        this.handleRefreshChild();
    }

    handleRefreshChild(){
        this.template.querySelector('c-pagination').childMethod();
    }

    handlePriceBtnClick(event){
        this.searchResults = [];
        this.resetPage = true;
        this.offset = 0;
        console.log('@@@@@@@@@ handlePriceBtnClick and resetPage = ' + this.resetPage);
        this.showBestPrice = !this.showBestPrice;
        this.showStandard = !this.showBestPrice;
        this.showFastestDel = !this.showBestPrice;
        this.sortingOption = 'Price Ascending';
        this.handleSearch();
        this.handleRefreshChild();
    }
    ...
    handleDelBtnClick(event){
        this.searchResults = [];
        console.log('@@@@@@@@@ handleDelBtnClick and resetPage = ' + this.resetPage);
        this.showFastestDel = !this.showFastestDel;
        this.showStandard = !this.showFastestDel;
        this.showBestPrice = !this.showFastestDel;
        this.sortingOption = 'Date Ascending';
        this.handleSearch();
        this.handleRefreshChild();
    }
    ...
    getBrands(result){
        if(result.data){
            if(this.showDropdown === true) {
                //Do nothing, this will be handled in the child component
            } else {
...
//----------------------------------------------HANDLER----------------------------------------------------------//
    ...
    clearSearch(){
        ...
        this.showFastestDel = false;
        this.resetPaginationComponent = true;
        this.offset = 0;
    ...
    handleAddToCart(event){
        ...
        addItemToCart({productId: productId, quantity: quantity, accountId: this.effectiveAccount, price: price, deliveryDate})
            .then((data) => {
                ...
                this._title = 'Success';
                this.variant = 'success';
                this.message = this.B2BSearcht_Toast_Add_CartItem;
                this.showNotification();
...
//--------------------------------------------------------------------------------------------------------------//
    handleBrandSelected(event){
        ...
        this.selectedBrands = event.detail;
